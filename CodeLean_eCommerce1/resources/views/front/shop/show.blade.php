            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="filter-widget">
                        <h4 class="fw-title">Cartegories</h4>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <div class="product-thumbs-tracks ps-slider owl-carousel">
                                    @foreach($product->productImages as $productImage)
                                    <div class="pt active" data-imgbigurl="front/img/product-single/{{$productImage->path}}"><img 
                                    src="front/img/product-single/{{$productImage->path}}" alt=""> </div>
                                    @endforeach
                                </div>
                            </div>
                         ...
                         <div class="product-details">
                          ...
                          <ul class="pd-tags">
                              <li><span>CARTEGORIES</span>:{{$product->productCategory->name}}</li>
                    ...
                    <div class="product-tab">
                        ...
                        <div class="tab-item-content">
                            <div class="tab-content">
                                <div class="tab-pane fade-in active" id="tab-1" role="tab-panel">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product-item">
                        ...
                        <div class="pi-text">
                            <div class="cartegory-name">{{$relatedProduct->tag}}</div>
