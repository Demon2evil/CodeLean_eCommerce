            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo">
                            <a href="index.html">
                                <front/img src="front/img/logo.png" height="25" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-7">
                        ...
                        <div class="advanced-search">
                            <button type="button" class="category-btn">ALL CARTEGORIES</button>
                    ...
                    <div class="col-lg-3 col-md-3 text">
                        <ul class="nav-right">
                            <li class="heart-icon">
                                <a href="#">
                                ...
                                <div class="cart-hover">
                                    <div class="select-items">
                                        <table>
                                            <tbody>
                                            <tr>
                                             <td class="si-pic"><front/img src="front/img/select-product-1.jpg" alt=""></td>   
                                             <td class="si-text">
                                            ...
                                            <tr>
                                                <td class="si-pic"><front/img src="front/img/select-product-2.jpg" alt=""></td>   
                                                <td class="si-text">
                                                    <div class="product-selected">
                                                       <p>$60.00 x 1</p>
                                                       <h6>Kabino Bedside Table</h6>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-left">
                        ...
                        <ul>
                            <li>Quan 12 . TP HCM</li>
                            <li>Phone: +84 79.22.78.734</li>
                            <li>Email: Phuochuy1408@gmail.com</li>
                        </ul>
                ...
                <div class="col-lg-4">
                    <div class="newslatter-item">
                      ...
                      <p>Get E-mail Update about our lastest shop and special offers.</p>
